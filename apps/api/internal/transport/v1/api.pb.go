...
const file_v1_api_proto_rawDesc = "" +
	"\n" +
	"\fv1/api.proto\x12\vdilocash.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"<\n" +
	...
	"\ftransactions\x18\x01 \x03(\v2\".dilocash.v1.ProcessIntentResponseR\ftransactions2\xaf\x01\n" +
	"\rIntentService\x12O\n" +
	"\rProcessIntent\x12\x1a.dilocash.v1.IntentRequest\x1a\".dilocash.v1.ProcessIntentResponse\x12M\n" +
	"\n" +
	"GetHistory\x12\x1e.dilocash.v1.GetHistoryRequest\x1a\x1f.dilocash.v1.GetHistoryResponseBHZFgithub.com/dilocash/dilocash-oss/apps/api/internal/transport;transportb\x06proto3"
...
var file_v1_api_proto_goTypes = []any{
	(*IntentRequest)(nil),         // 0: dilocash.v1.IntentRequest
...
var file_v1_api_proto_depIdxs = []int32{
	...
	0, // 2: dilocash.v1.IntentService.ProcessIntent:input_type -> dilocash.v1.IntentRequest
